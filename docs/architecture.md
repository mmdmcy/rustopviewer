...
- `assets/remote.html` contains the current desktop/mobile browser client, including desktop keyboard capture, mobile touch controls, and fit-to-window viewer logic.
